...
NOTE : function scope can be achieved using var, but block scope can't be achieved using var

NOTE : both function scope & block scope can be achieved using let & const 

NOTE : Variables and functions defined in the parent scope will be accessible to child scope, but variables and functions defined in the child scope won't be accessible in it's parent scope
*/
